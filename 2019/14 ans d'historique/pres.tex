...
\begin{document}
	...
	\frame{
		...
		\begin{itemize}
			...
			\item \pause Pas de CheckConstraint et autre contrainte exclusive à PostgreSQL
			\item \pause Datetime naïves
			\item \pause Pas de chiffrement sur les colonnes de type UUID
			\item \pause Pas de véritable Booléen
		\end{itemize}
	}	
	\frame{
		\frametitle{Evolutions et intégrations dans AnyBlok}
